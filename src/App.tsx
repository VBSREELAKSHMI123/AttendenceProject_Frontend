...
function App() {
  ...
  return (
    <Routes>
      <Route element={<ProtectedRoute allowedroles={["user", "admin"]}><UserDashboard /></ProtectedRoute>} path='/dash'>
        ...
        <Route element={<ProtectedRoute allowedroles={["user", "admin"]}>< Profile/></ProtectedRoute>} path='profile' />
        {/* <Route index element={<h1> dashboard</h1>} /> */}
      </Route>

      <Route element={!isAuthenticated ? <LoginPage /> : <Navigate to={"/dash"} />} path='/' />
